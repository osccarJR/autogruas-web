    ...
    <section id="cobertura" className="py-20 sm:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-gray-900 mb-6 text-3xl sm:text-4xl lg:text-5xl">Cobertura en Quito y valles</h2>
          <div className="w-20 h-1 bg-[#E3B221] mx-auto mb-4"></div>
          <p className="text-gray-600 text-lg">Llegamos rápido a donde necesites grua.</p>
        </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Llegamos rapidamente a todo Quito, Cumbayá, Tumbaco, Los Chillos y zonas aledanas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-gray-900 mb-2 text-xl">Respuesta rapida</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Nuestro tiempo de respuesta promedio es menor a 20 minutos en cualquier punto de la ciudad.
                  </p>
                </div>
              </div>
            </div>

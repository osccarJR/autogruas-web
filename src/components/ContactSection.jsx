...
export default function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappMessage = `Hola, soy ${formData.name}. Me quedé varado y necesito una grúa: ${formData.message}. Mi teléfono es ${formData.phone}`;
    ...
    <section id="contacto" className="py-20 sm:py-28 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-gray-900 mb-4 text-3xl sm:text-4xl lg:text-5xl">Comunícate con nosotros ahora</h2>
          <div className="w-20 h-1 bg-[#E3B221] mx-auto mb-6"></div>
          <p className="text-gray-600 text-xl">Servicio de grúas disponible 24/7</p>
        </div>
          ...
          >
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/90 mb-4 text-lg">Coordinación inmediata</p>
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <div className="bg-gray-50 p-8 sm:p-10 rounded-2xl border-2 border-gray-200">
            ...
            <p className="text-gray-600 text-center mb-8">Te contactamos para enviar tu grúa</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ej: Me quedé varado en la Av. 6 de Diciembre, necesito grúa al taller..."
                  required
                ></textarea>
              </div>

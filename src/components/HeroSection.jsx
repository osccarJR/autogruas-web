      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-white mb-6 sm:mb-8 leading-tight">
            <span className="block text-3xl sm:text-5xl lg:text-6xl mb-3 sm:mb-4">🚨 ¿Problemas con tu auto?</span>
            <span className="block text-2xl sm:text-4xl lg:text-5xl text-[#E3B221]">Llegamos en 20 minutos</span>
          </h1>

          <p className="text-white text-lg sm:text-xl lg:text-2xl mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed">
            Servicio de grúas y winchas en
            <span className="text-[#E3B221]"> todo Quito</span>.
